...
# =============================================================================
# YOLOv8 PIPELINE EXECUTION SCRIPT
# =============================================================================
# This script provides various scenarios for running YOLOv8 trash image segmentation
# 
# USAGE:
#   ./run_yolov8_pipeline.sh [scenario]
#
# SCENARIOS:
#   1. train_new          - Train a new YOLOv8 model from scratch
...
#   9. all_models         - Run all YOLOv8 variants (v8n, v8s, v8m, v8l, v8x)
...
MODEL_VERSION="v8n"  # Change to v8s, v8m, v8l, v8x as needed
...
run_train_new() {
    print_header "YOLOv8 TRAINING NEW MODEL"
...
run_use_existing() {
    print_header "YOLOv8 USING EXISTING RESULTS"
    print_status "Model: $MODEL_VERSION"
...
run_complete_pipeline() {
    print_header "YOLOv8 COMPLETE PIPELINE"
    print_status "Model: $MODEL_VERSION"
...
run_safe_pipeline() {
    print_header "YOLOv8 SAFE PIPELINE"
    print_status "Model: $MODEL_VERSION"
...
run_onnx_export() {
    print_header "YOLOv8 ONNX EXPORT"
    print_status "Model: $MODEL_VERSION"
...
run_analysis_only() {
    print_header "YOLOv8 ANALYSIS ONLY"
    print_status "Model: $MODEL_VERSION"
...
run_inference_only() {
    print_header "YOLOv8 INFERENCE ONLY"
    print_status "Model: $MODEL_VERSION"
...
run_rknn_only() {
    print_header "YOLOv8 RKNN CONVERSION ONLY"
    print_status "Model: $MODEL_VERSION"
...
# Function to run all YOLOv8 variants
run_all_models() {
    print_header "YOLOv8 ALL VARIANTS"
    print_status "Running all YOLOv8 variants: v8n, v8s, v8m, v8l, v8x"
...
run_custom() {
    print_header "YOLOv8 CUSTOM CONFIGURATION"
    print_status "Model: $MODEL_VERSION"
...
show_help() {
    print_header "YOLOv8 PIPELINE HELP"
    print_mode "Current execution mode: $EXEC_MODE"
    echo ""
    echo "Available scenarios:"
    echo "  1. train_new          - Train a new YOLOv8 model from scratch"
    ...
    echo "  9. all_models         - Run all YOLOv8 variants"
    ...
    echo ""
    echo "Examples:"
    echo "  ./run_yolov8_pipeline.sh train_new"
    echo "  ./run_yolov8_pipeline.sh use_existing"
    echo "  ./run_yolov8_pipeline.sh complete_pipeline"
    echo "  ./run_yolov8_pipeline.sh local_mode train_new"
    echo "  ./run_yolov8_pipeline.sh colab_mode train_new"
    echo ""
    ...
    echo "  EPOCHS=50 ./run_yolov8_pipeline.sh train_new"
    echo "  BATCH_SIZE=16 ./run_yolov8_pipeline.sh train_new"
    echo "  IMAGE_SIZE=640 ./run_yolov8_pipeline.sh train_new"
}

# Main execution
main() {
    print_header "YOLOv8 TRASH IMAGE SEGMENTATION PIPELINE"
    ...
    print_success "YOLOv8 pipeline execution completed!"
}
